...
obj_info_mpath = base_path + 'train_1200-1500/{:02d}/info.yml'
obj_gt_mpath = base_path + 'train_1200-1500/{:02d}/gt.yml'
rgb_mpath = base_path + 'train_1200-1500/{:02d}/rgb/{:04d}.png'
depth_mpath = base_path + 'train_1200-1500/{:02d}/depth/{:04d}.png'
